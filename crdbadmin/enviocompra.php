          ...
          <form>
            <div class="container">
              ...
              <?php
                ...
                $cbotipocompra=$_POST['cbotipocompra'];
                $cbocomprador=$_POST['cbocomprador'];

                //Conexion MYSQL
                require("conexion.php");

                //Subir el nuevo usuario
                $query="INSERT INTO compras VALUES (0,'$fechacompra','$productocompra','$montocompra','$cbotipocompra','$cbocomprador')";
